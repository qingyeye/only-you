...
public class QuartzEntity{
	...
	private String jobMethonName;//执行类
	...
	public String getJobMethonName() {
		return jobMethonName;
	}

	public void setJobMethonName(String jobMethonName) {
		this.jobMethonName = jobMethonName;
	}
